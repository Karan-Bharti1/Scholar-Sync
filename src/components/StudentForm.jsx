...
<label htmlFor="name">Name:</label>
   ...
   <label htmlFor="male"> <input name="gender" type="radio" value={studentName.gendere} onChange={handleChange} required id="male" />Male</label>{"   "}
   <label htmlFor="female"> <input name="gender" type="radio" value={studentName.gender} onChange={handleChange} required id="female" />Female</label>
   <br/><br/>
   {editChange &&(<>
